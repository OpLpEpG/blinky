...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x8000000 + 0x1000), LENGTH = (128*1K - 0x1000)
    SRAM (wx) : ORIGIN = 0x20000000, LENGTH = (20 * 1K)
    IDT_LIST (wx) : ORIGIN = (0x20000000 + (20 * 1K)), LENGTH = 2K
    }
ENTRY("__start")
SECTIONS
    {
 ...
 *(.iplt)
 ...
 _image_rom_start = (0x8000000 + 0x1000);
    text :
 {
. = 0x0;
. = ALIGN(4);
